...
export async function generateMetadata() {
  return {
    title: 'New In — Sell Your Shelf',
    description: 'The latest secondhand books listed on Sell Your Shelf',
    openGraph: {
      title: 'New In — Sell Your Shelf',
      description: 'The latest secondhand books listed on Sell Your Shelf',
      ...
      <div style={{ borderBottom: '0.5px solid #E5E3DF', padding: '32px 24px 24px' }}>
        <div style={{ maxWidth: 840, margin: '0 auto' }}>
          ...
          <div style={{ fontSize: 14, color: '#666' }}>
            The latest books listed — updated in real time
          </div>
        </div>
      </div>

      <div style={{ maxWidth: 840, margin: '0 auto', padding: '24px 16px' }}>
        <ShelfGrid listings={safeListings} showSeller />
      </div>
