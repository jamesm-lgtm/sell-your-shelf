    ...
    <div className="sy-page">
      ...
      <main className="py-16">
        <div className="max-w-2xl mx-auto px-6">
          <h1 className="sy-h2" style={{ marginBottom: 28 }}>Privacy Policy</h1>
          <p className="sy-prose" style={{ marginBottom: 28 }}>Last updated: March 2026</p>

          <div className="space-y-8 sy-prose">
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>1. Who we are</h2>
              <p>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>2. What data we collect</h2>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>3. How we use your data</h2>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>4. Legal basis for processing</h2>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>5. Who we share data with</h2>
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li><strong>InPost:</strong> shipping and delivery (name and address for shipping labels)</li>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>6. Data retention</h2>
              <p>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>7. Your rights</h2>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>8. Cookies and tracking</h2>
              <p>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>9. Data security</h2>
              <p>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>10. International transfers</h2>
              <p>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>11. Children</h2>
              <p>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>12. Changes to this policy</h2>
              <p>
            ...
            <section>
              <h2 className="sy-h3" style={{ marginBottom: 12 }}>13. Complaints</h2>
              <p>
